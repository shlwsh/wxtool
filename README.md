[![wxtool](https://github.com/shlwsh/wxtool)]
# wxtool  (适用PC微信3.9.11.17版本）

### 欢迎指出bug，欢迎pull requests

Windows版本微信客户端自动化，可实现简单的发送、接收微信消息、保存聊天图片及相关文件到指定目录中
...
[![Star History Chart](https://api.star-history.com/svg?repos=shlwsh/wxtool&type=Date)](https://star-history.com/#shlwsh/wxtool)
...
## 示例
> [!NOTE]
> 如有问题请先查看[使用文档](https://github.com/shlwsh/wxtool/docs/intro)
...
[微信交流群](https://github.com/shlwsh/wxtool/docs/intro#-%E4%BA%A4%E6%B5%81)
